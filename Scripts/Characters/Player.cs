...
public partial class Player : CharacterBody3D
{
	...
	public override void _Ready()
	{
		...
		PlayerCharacter = CharacterSystem.Instance.GetPlayerCharacter();
	}
	...
	public override void _Process(double delta)
	{
		...
		if (Input.IsActionJustPressed("player_info"))
		{
			CanMove = false;
			var infoMenu = GetTree().CurrentScene.GetNode<CharacterInfoMenu>("CharacterInfoMenu");
			infoMenu.ShowCharacterInfo(PlayerCharacter);
			infoMenu.OnClose = () =>
			{
				CanMove = true;
				infoMenu.HideCharacterInfo();
				return true;
			};
		}
		base._Process(delta);
